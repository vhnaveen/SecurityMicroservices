...
using SecurityMicroservice_B.Middlewares;
using SecurityMicroservice_B.Utilities;
...
builder.Services.AddSwaggerGen(options =>
{
        ...
        Flows = new OpenApiOAuthFlows
        {
            AuthorizationCode = new OpenApiOAuthFlow
            {
                ...
                Scopes = new Dictionary<string, string>
                    {
                        { apiScope, "Access Request Management Workspace API" }
                    }
            }
        }
    });
    ...
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "Security Microservice B", Version = "v1" });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        ...
        c.SwaggerEndpoint("/" + c.RoutePrefix + "/v1/swagger.json", "SecurityMicroservice.B");
